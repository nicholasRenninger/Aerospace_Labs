function truss3dMonteCarlo(inputfile)
...
%Edited: 10/10/16 - Lucas Calvert, Alan Tett, Krish Desai
...
numsamples = 1e2;   % number of samples
...
for is=1:numsamples
    ...
    [barforces,reacforces] = forceanalysis_3d(randjoints,connectivity,reacjoints,reacvecs,loadjoints,loadvecs);
...
probFailure = sum(failure)/numsamples;
FoS = factorofSafety(jstrmean,jstrcov,probFailure);
