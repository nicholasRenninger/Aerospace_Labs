function setSensGlobals(global_sens_conditions)
    ...
    P_air_init = global_sens_conditions(1); % [Pa]
    V_water_init = global_sens_conditions(2); % [m^3]
    C_drag = global_sens_conditions(3); % [unitless]
    theta_init = global_sens_conditions(4); % [rad]
    rho_water_init = global_sens_conditions(5); % [kg/m^3]
